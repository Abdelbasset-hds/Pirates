...
public class Pirate {
    ...
    private Carte[] zonePopularite; // Nouveau : zone de popularit�
    private int compteurPopularite = 0; // Nouveau : compteur pour la zone de popularit�

    public Pirate(String nom) {
        this.nom = nom;
        this.main = new Carte[5];
        this.zonePopularite = new Carte[20]; // Taille maximale de la zone de popularit�
    }
	...
	public Carte[] getMain() {
	    Carte[] cartesActuelles = new Carte[compteur]; // Cr�er un tableau de la taille des cartes poss�d�es
